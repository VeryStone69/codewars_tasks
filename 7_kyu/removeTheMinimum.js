...
//     let minIndex = numbers.indexOf(numbersSorted[0])
//     numbers.slice(numbersSorted[0],minIndex)
//     return numbers;
// }

function removeSmallest(numbers) {
    const indexToRemove = numbers.indexOf(Math.min(...numbers));
    return numbers.slice(0, indexToRemove).concat(numbers.slice(indexToRemove + 1));
}

console.log(removeSmallest([11, 222, 333, 4, 5]))
